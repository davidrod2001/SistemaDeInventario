package davidrod.inventory.controlador;

import davidrod.inventory.excepcion.RecursoNoEncontradoExcepcion;
import davidrod.inventory.modelo.Producto;
import davidrod.inventory.servicio.ProductoServicio;
...
public class ProductoControlador {
    ...
    @GetMapping("/productos")   //http://localhost:8080/inventory-app/productos
